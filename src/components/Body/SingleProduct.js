...
import NotFoundPage from "./../Other_files/NotFoundPage";

export default function SingleProduct() {
  let dataRequired = JSON.parse(localStorage.getItem("product"));
  const params = useParams();
  if (dataRequired.id == params.productID) {
    return (
        ...
        <div className="row blue ms-2 ">
          ...
          <div className="col-lg-8 pink ">
            ...
            <p>
              ...
              Flat ₹1,250 Off on HDFC Bank Credit Card EMI Trxns on orders
              priced between ₹15,000 to ₹39,999 <a href="#">T&C</a> <br></br>
              <FontAwesomeIcon icon={faTag} className="sky" /> <b>Bank Offer</b>{" "}
              Flat ₹3,000 Off on HDFC Bank Credit Card EMI Trxns on orders
              priced between ₹40,000 to ₹49,999 <a href="#">T&C</a> <br></br>
              <FontAwesomeIcon icon={faTag} className="sky" /> <b>Bank Offer</b>{" "}
